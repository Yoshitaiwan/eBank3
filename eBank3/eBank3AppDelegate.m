...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
	...
	NSString *storePath = [[self applicationDocumentsDirectory] stringByAppendingPathComponent: @"eMint.sqlite"];
	/*
	 Set up the store.
	...
	if (![fileManager fileExistsAtPath:storePath]) {
		NSString *defaultStorePath = [[NSBundle mainBundle] pathForResource:@"eMint" ofType:@"sqlite"];
		if (defaultStorePath) {
